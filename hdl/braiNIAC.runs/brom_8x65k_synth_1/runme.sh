...
HD_PWD='C:/Users/Curtis Bucher/OneDrive - Cal Poly/braiNIAC/braiNIAC.runs/brom_8x65k_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log brom_8x65k.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source brom_8x65k.tcl
