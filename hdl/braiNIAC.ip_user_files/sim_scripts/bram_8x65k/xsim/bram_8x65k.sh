...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xpm -L blk_mem_gen_v8_4_4 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot bram_8x65k xil_defaultlib.bram_8x65k xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bram_8x65k -key {Behavioral:sim_1:Functional:bram_8x65k} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bram_8x65k.wdb xsim.dir)
